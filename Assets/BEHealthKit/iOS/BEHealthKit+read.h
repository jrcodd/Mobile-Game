...
/*! @brief                      begins a background observer query
	@details                    Begins an HKAnchoredObjectQuery [HKDocumentQuery](https://developer.apple.com/documentation/healthkit/hkanchoredobjectquery) for the specified data type.
	@param identifierString     the data type
 */
