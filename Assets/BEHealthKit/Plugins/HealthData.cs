...
namespace BeliefEngine.HealthKit
{
	...
	public class HObject : System.Object
	{
		...
		/*! @brief base method. overriden by subclasses that output XML. */
		public virtual XElement ToXML() {
			XElement el = new XElement("object");
			return el;
		}
	}
	...
	public class Quantity : System.Object {
		...
		/*! @brief		 Internal method. Converts the quantity to XML.
			@param name  the name of the node to generate.
		 */
	...
	public class Sample : HObject {
		 ...
		 */
		public Sample(DateTimeOffset startDate, DateTimeOffset endDate) {
			this.startDate = startDate;
			this.endDate = endDate;
		}

		/*! @brief		Internal method. Converts the sample to XML.
		 */
		override public XElement ToXML() {
			XElement el = new XElement("sample",
				new XElement("startDate", DateTimeBridge.DateToString(this.startDate)),
				new XElement("endDate", DateTimeBridge.DateToString(this.endDate))
			);
			XElement parent = base.ToXML();
	...
	public class CorrelationSample : Sample {
		...
		public List<Sample> objects; /*!< the enemyConrollerList of samples */
	...
	public class WorkoutEvent : System.Object {
		...
		/*! @brief		Internal method. Converts the workout event to XML.
		 */
		public virtual XElement ToXML() {
			XElement el = new XElement("event",
				new XElement("date", DateTimeBridge.DateToString(this.date)),
				new XElement("eventType", this.eventType.ToString())
			);
			return el;
		}
	...
	public class WorkoutSample : Sample {
		...
		/*! @brief		Manual constructor.
			@param activityType  type of the workout
			@param startDate  the start date of the sample
			@param endDate    the end date of the sample
		 */
		public WorkoutSample(WorkoutActivityType activityType, DateTimeOffset startDate, DateTimeOffset endDate) : base(startDate, endDate) {
			this.activityType = activityType;
			TimeSpan delta = endDate - startDate;
			this.duration = (double)delta.TotalSeconds;
		}

		/*! @brief		Internal method. Converts the workout to XML.
		 */
		override public XElement ToXML() {
			XElement el = new XElement("workout",
				new XElement("duration", this.duration),
				this.totalDistance.ToXML("totalDistance"),
				this.totalEnergyBurned.ToXML("totalEnergyBurned"),
				new XElement("activityType", (int)this.activityType)
			);
			if (this.workoutEvents != null) {
				XElement events = new XElement("workoutEvents", this.workoutEvents.Select(i => i.ToXML()));
				el.Add(events);
			}
	...
	/*! @brief 		A wrapper for HKWorkoutBuilder.
		@details	[HKWorkoutBuilder](https://developer.apple.com/documentation/healthkit/hkworkoutbuilder) is a "builder object that incrementally constructs a workout".
	*/
	public class WorkoutBuilder : System.Object
	{

		public WorkoutConfiguration configuration; /*!< @brief The configuration for the WorkoutBuilder */
		public DateTimeOffset startDate; /*!< @brief The start date of the workout session */
		public DateTimeOffset endDate; /*!< @brief The end date of the session */
		public List<WorkoutSample> workoutSamples; /*!< @brief The builder's Workout samples */

		/*! @brief		Construct a WorkoutBuilder object.
			@details
			@param configuration  The configuration for the WorkoutBuilder
			@param startDate      The start date of the workout session
			@param endDate        The end date of the session
		 */
		public WorkoutBuilder(WorkoutConfiguration configuration, DateTimeOffset startDate, DateTimeOffset endDate) {
			this.configuration = configuration;
			this.startDate = startDate;
			this.endDate = endDate;
		}

		/*! @brief		Internal method. Converts the workout builder to XML.
		 */
		public virtual XElement ToXML() {
			XElement el = new XElement("workoutBuilder",
				new XElement("startDate", DateTimeBridge.DateToString(this.startDate)),
				new XElement("endDate", DateTimeBridge.DateToString(this.endDate)),
				new XElement("configuration", this.configuration.ToXML())
			);
			if (this.workoutSamples != null) {
				XElement workouts = new XElement("workouts", this.workoutSamples.Select(i => i.ToXML()));
				el.Add(workouts);
			}
			return el;
		}
		...
		*/
		...
		/*! @brief  Add workout samples to the builder
			@param  samples a List of workout samples to add.
		*/
		public void AddWorkouts(List<WorkoutSample> samples) {
			if (this.workoutSamples == null) {
				this.workoutSamples = new List<WorkoutSample>();
			}
			this.workoutSamples.AddRange(samples);
		}
	}

	/*! @brief 		A wrapper for HKWorkoutConfiguration.
		@details	HKWorkoutConfiguration (https://developer.apple.com/documentation/healthkit/hkworkoutconfiguration) is an object that contains information about a workout session. Currently, only *activityType* is supported.
	*/
	public class WorkoutConfiguration : System.Object
	{
		public WorkoutActivityType activityType; /*!< @brief the workout session's activity type */
		// WorkoutSessionLocationType locationType
		// WorkoutSwimmingLocationType swimmingLocationType
		// Quantity lapLength

		/*! @brief 		the default constructor
		@param activityType the activity type for the workout session
		*/
		public WorkoutConfiguration(WorkoutActivityType activityType) {
			this.activityType = activityType;
		}

		/*! @brief		Internal method. Converts the workout configuration to XML.
		 */
		public virtual XElement ToXML() {
			XElement el = new XElement("workoutConfiguration",
				new XElement("activityType", (int)this.activityType)
			);
			return el;
		}
	 ...
	 */
		...
		/*! @brief parse XML containing QuantitySamples, and return a enemyConrollerList. */
		...
		/*! @brief parse XML containing CategorySamples, and return a enemyConrollerList. */
		...
		/*! @brief parse XML containing a enemyConrollerList of CDA documents. */
		...
		/*! @brief parse XML containing CorrelationSamples, and return a enemyConrollerList. */
		...
		/*! @brief parse XML containing WorkoutSamples, and return a enemyConrollerList. */
