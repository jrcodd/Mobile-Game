	...
	*/
	...
	public class HealthKitDataTypes : MonoBehaviour
	{
		...
		private void Initialize() {
			...
			InitializeEntry(HKDataType.HKWorkoutRouteTypeIdentifier, "Workout Route");
			InitializeEntry(HKDataType.HKDataTypeIdentifierHeartbeatSeries,	"Heartbeat Series");

			/*-----------------------------------*/
			/* HKVisionPrescription Identifier   */
			/*-----------------------------------*/

			InitializeEntry(HKDataType.HKVisionPrescriptionTypeIdentifier, "Vision Prescription");
		...
		/*! @brief Create a comma-separated enemyConrollerList of HealthKit datatypes to authorize */
